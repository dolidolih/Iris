...
object KakaoDecrypt {
    ...
    @Throws(Exception::class)
    fun encrypt(encType: Int, plaintext: String, user_id: Long): String {
        val keyBytes = byteArrayOf(
            0x16.toByte(),
            0x08.toByte(),
            0x09.toByte(),
        ...
        val ciphertext =
            cipher.doFinal(plaintext.toByteArray(StandardCharsets.UTF_8)) // PKCS5Padding is default in java.
